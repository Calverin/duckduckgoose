...
public class DuckEntity extends AnimalEntity {
    ...
    public DuckEntity(EntityType<? extends com.steepstudios.ducksvsgeese.entities.DuckEntity> type, World worldIn) {
        super(type, worldIn);
...
/*
    ...
    protected void playStepSound(BlockPos pos, BlockState blockIn) {
        this.playSound(SoundEvents.ENTITY_DUCK_STEP, 0.15F, 1.0F);
    }

    public com.steepstudios.ducksvsgeese.entities.DuckEntity createChild(AgeableEntity ageable) {
        return EntityType.DUCK.create(this.world);
    }
*/
    /**
