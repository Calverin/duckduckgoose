...
import com.steepstudios.duckduckgoose.entities.GooseEntity;
...
public class GooseRenderer extends MobRenderer<GooseEntity, ChickenModel<GooseEntity>> {
    ...
    private static final ResourceLocation GOOSE_TEXTURE = new ResourceLocation(DuckDuckGoose.MODID, "textures/entity/goose/goose.png");
