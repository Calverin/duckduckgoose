...
import com.steepstudios.ducksvsgeese.entities.DuckEntity;
...
public class DuckRenderer extends MobRenderer<DuckEntity, ChickenModel<DuckEntity>> {
    ...
    private static final ResourceLocation DUCK_TEXTURE = new ResourceLocation(DucksVsGeese.MODID, "textures/entity/duck/duck.png");
