...
public final class ModItems {
    ...
    public static final RegistryObject<ModdedSpawnEggItem> GOOSE_SPAWN_EGG = ITEMS.register("goose_spawn_egg", () -> new ModdedSpawnEggItem(ModEntityTypes.GOOSE, 0xF0A5A2, 0xA9672B, new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
}
